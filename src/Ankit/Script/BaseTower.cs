    ...
    public void OnBodyEntered(Area2D area)
{
    ...
    {
        GD.Print("OnBodyEntered: Parent is BaseChicken");
        if (CanTargetChicken(chicken))
        {
            currentTarget = chicken;
            GD.Print("OnBodyEntered: Target set successfully");
        }
        else
        {
            GD.Print("OnBodyEntered: Chicken cannot be targeted");
        }
    }
}
...
public void OnBodyExited(Area2D area)
{
    ...
    if (parent is BaseChicken chicken && chicken == currentTarget)
    {
        currentTarget = null;
        GD.Print("OnBodyExited: Target cleared");
    }
}
